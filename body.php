            ...
            <table class="reservation-box-table">
                    <tr>
                        ...
                        <td style="vertical-align:middle;width:17%;"><p><p  type="text">CHECK-OUT</p><input type="text"  class="inputtypewith" id="datepicker2"></p></td>
                          <td style="vertical-align:middle;width:12%;"><b>PROMO<br> </b><input id="promo" class="inn" type="text"></td>
                          <td style="vertical-align:middle;width:12%;"><b>GROUP<br> </b><input id="group" class="inn" type="text"></td>
                          <td style="vertical-align:middle;width:12%;"><b>CORP ID<br> </b><input id="corp" class="inn" type="text"></td>
                        <td style="vertical-align:middle;width:8%;"><b>ADULT<br> </b><input id="adults" class="in" type="text" value="1"></td>
                      
                   
                        <td style="vertical-align:middle;width:8%;"><b >CHILD<br> </b><input id="child" class="in" type="text" value="0"></td>
